...
const modeIconMobile = $('#modeIconMobile');
...
function savePreferences() {
  ...
  modeToggleButton.on('click', function () {
    ...
    if (isDarkMode) {
      modeToggleButton.html('<i id="modeIcon" class="fas fa-moon"></i> Toggle Dark Mode');
    } else {
      modeToggleButton.html('<i id="modeIcon" class="fas fa-sun"></i> Toggle Light Mode');
    }
